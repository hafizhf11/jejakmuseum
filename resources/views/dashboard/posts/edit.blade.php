...
<div class="col-lg-8">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control @error('kabupaten') is-invalid @enderror" id="kabupaten" name="kabupaten" value="{{ old('kabupaten', $post->kabupaten) }}">
        @error('kabupaten')
        <div class="invalid-feedback">
            {{ $message }}
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="integer" class="form-control" id="jumlah_koleksi" name="jumlah_koleksi" value="{{ old('jumlah_koleksi', $post->jumlah_koleksi) }}">
        </div>
        <div class="mb-3">
          <label for="pemilik" class="form-label">Pemilik</label>
          <input type="text" class="form-control" id="pemilik" name="pemilik" value="{{ old('pemilik', $post->pemilik) }}">
        </div>
        <div class="mb-3">
          <label for="tipe_terakhir" class="form-label">Tipe Terakhir</label>
          <input type="text" class="form-control" id="tipe_terakhir" name="tipe_terakhir" value="{{ old('tipe_terakhir', $post->tipe_terakhir) }}">
        </div>
        <div class="mb-3">
          <label for="nomor_pendaftaran" class="form-label">Nomor Pendaftaran</label>
          <input type="text" class="form-control" id="nomor_pendaftaran" name="nomor_pendaftaran" value="{{ old('nomor_pendaftaran', $post->nomor_pendaftaran)  }}">
        </div>
      ...
      <!-- Maps -->
        <div class="mb-3">
          ...
          <input type="url" class="form-control @error('maps_link') is-invalid @enderror" 
                ...
                value="{{ old('maps_link', $post->maps_link) }}">
          @error('maps_link')
          <div class="invalid-feedback">
              {{ $message }}
          </div>
