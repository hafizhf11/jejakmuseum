    ...
    @if ($articles->count())
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card article-card border-0 shadow-sm h-100 rounded-4 overflow-hidden">
                    <!-- Link di luar konten untuk membuat seluruh card clickable -->
                    <a href="/articles/{{ $article->slug }}" class="card-link-overlay"></a>
                    
                    <div class="article-image-container position-relative">
                        @if($article->image)
                            <img src="{{ asset('storage/' . $article->image) }}" class="article-image card-img-top" alt="{{ $article->title }}" style="height: 240px; object-fit: cover;">
                        @else
                            <img src="https://source.unsplash.com/500x400?museum" class="article-image card-img-top" alt="{{ $article->title }}" style="height: 240px; object-fit: cover;">
                        @endif
                    ...
                    <div class="card-body d-flex flex-column p-4">
                        ...
                        <div class="mt-3 read-more">
                            <span class="text-decoration-none" style="color: #8b5d33;">
